          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-bold text-gray-700 mb-1">
                {formData.transactionType === 'إيجار' ? 'السعر (بالآلاف) *' : 'السعر (بالملايين) *'}
              </label>
              <div className="relative">
                <input
                  ...
                  dir="ltr"
                  placeholder={formData.transactionType === 'إيجار' ? 'مثال: 50' : 'مثال: 1.5'}
                />
                <span className="absolute right-3 top-3 text-gray-500 text-sm pointer-events-none">
                  {formData.transactionType === 'إيجار' ? 'ألف' : 'مليون'}
                </span>
              </div>
            </div>
          </div>
